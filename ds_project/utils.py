...
def train_model(model, train_batch_generator, val_batch_generator, opt, loss_fn, n_epochs,
                ckpt_name=None, visualize=False):
    """
    ...
    for epoch in range(n_epochs):
        ...
        # Evaluation phase
        metric_results = test_model(model, val_batch_generator, loss_fn, subset_name='val')
